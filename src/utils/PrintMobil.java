...
public class PrintMobil implements Printable {
    private JTable table;
    private static final int MARGIN = 50;
    
    public PrintMobil(JTable table) {
        this.table = table;
    }
    ...
    public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
        ...
        String title = "DATA MOBIL RENTAL";
        ...
        int[] columnWidths = {80, 200, 150, 150}; // Adjusted for ID, Nama Mobil, Jenis Mobil, Harga Per Hari
        int startY = 100;
        int startX = MARGIN;
        
        // Draw table headers
        String[] headers = {"ID", "NAMA MOBIL", "JENIS MOBIL", "HARGA PER HARI"};
        int currentX = startX;
